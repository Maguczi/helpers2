                    ...
                    {tab === "phoneNumber" && (
                      <div>
                        ...
                        <Typography color="text.secondary">
                          Zalter Identity does support SMS passcodes, but to
                          prevent unnecessary costs we disabled this feature in
                          the demo.
                        </Typography>
                      </div>
                    )}
          ...
          >
            <Box sx={{ p: 3 }}>
              ...
              <Typography align="center" sx={{ mb: 3 }} variant="subtitle1">
                Create secure, seamless user experiences with Zalter
